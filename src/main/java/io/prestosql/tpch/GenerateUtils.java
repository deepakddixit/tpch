...
public final class GenerateUtils
{
    ...
    public static Integer formatDateAsInt(int epochDate)
    {
    ...
    public static Double formatMoneyAsDouble(long value)
    {
        // todo there must be a better way to do this
        return new BigDecimal(value).divide(new BigDecimal(100)).setScale(2).doubleValue();
    }
}
